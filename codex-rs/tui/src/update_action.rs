...
pub enum UpdateAction {
    /// Update via `npm install -g @hyperxenonzephyr/kv-code@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @hyperxenonzephyr/kv-code@latest`.
    BunGlobalLatest,
    /// Update via `brew upgrade --cask kv-code`.
    BrewUpgrade,
    /// Update via the KV Code Unix installer.
    StandaloneUnix,
    /// Update via the KV Code Windows installer.
    StandaloneWindows,
}
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            ...
            UpdateAction::BunGlobalLatest => {
                ("bun", &["install", "-g", "@hyperxenonzephyr/kv-code"])
            }
            UpdateAction::BrewUpgrade => ("brew", &["upgrade", "--cask", "kv-code"]),
