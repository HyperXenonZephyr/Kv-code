...
/// 2. The vendored bubblewrap tree under `kv-code-rs/vendor/bubblewrap`.
...
Set CODEX_BWRAP_SOURCE_DIR to an existing checkout or vendor bubblewrap under kv-code-rs/vendor.",
        vendor_dir.display()
    ))
}
