...
#[derive(Debug, Parser)]
#[command(bin_name = "kv-code plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "kv-code plugin add",
    after_help = "Examples:\n  kv-code plugin add sample@debug\n  kv-code plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "kv-code plugin list",
    after_help = "Examples:\n  kv-code plugin list\n  kv-code plugin list --marketplace debug\n  kv-code plugin list --json\n  kv-code plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "kv-code plugin remove",
    after_help = "Examples:\n  kv-code plugin remove sample@debug\n  kv-code plugin remove sample --marketplace debug"
)]
