...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/HyperXenonZephyr/Kv-code/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const APP_TOOLTIP: &str = "Try **KV Code** with `kv-code app` when the desktop shell is available.";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("kv-code app") {
                return false;
            }
            true
        })
...
/// Pick a random tooltip to show to the user when starting KV Code.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // KV Code currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for KV Code TUI.
...
[[announcements]]
content = "Welcome to KV Code! Check out the new onboarding flow."
