//! Tracks when KV Code-owned transcript scrollback must be repaired after terminal resize.
//!
...
//! as the source of truth, clears KV Code-owned history, and re-emits the cells at the current width.
