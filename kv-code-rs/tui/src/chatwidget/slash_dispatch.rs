            ...
            SlashCommand::Providers => {
                ...
                self.bottom_pane.show_selection_view(SelectionViewParams {
                    ...
                    items: vec![
                        SelectionItem {
                            name: "DeepSeek".into(),
                            description: Some("api.deepseek.com".into()),
                            actions: vec![Box::new(move |_| {
                                tx1.send(crate::app_event::AppEvent::ApiKeyInput(
                                    "deepseek".into(),
                        ...
                        SelectionItem {
                            name: "OpenAI".into(),
                            description: Some("api.openai.com/v1".into()),
                            actions: vec![Box::new(move |_| {
                                tx2.send(crate::app_event::AppEvent::ApiKeyInput(
                                    "openai".into(),
                        ...
                        SelectionItem {
                            name: "Kimi".into(),
                            description: Some("api.moonshot.cn/v1".into()),
                            actions: vec![Box::new(move |_| {
                                tx3.send(crate::app_event::AppEvent::ApiKeyInput(
                                    "kimi".into(),
                        ...
                        SelectionItem {
                            name: "Ollama".into(),
                            description: Some("localhost:11434".into()),
                            actions: vec![Box::new(move |_| {
                                tx4.send(crate::app_event::AppEvent::ApiKeyInput(
                                    "ollama".into(),
