...
//!
//! For the detailed burst state machine, see `kv-code-rs/tui/src/bottom_pane/paste_burst.rs`.
//!
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            "Ask KV Code to do anything".to_string(),
    ...
    fn status_line_hyperlink_marks_pr_number_cells() {
        ...
        let url = "https://github.com/HyperXenonZephyr/Kv-code/pull/20252";
        composer.set_status_line_enabled(/*enabled*/ true);
    ...
    fn set_skill_mentions_refreshes_open_mention_popup() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            ...
            description: "Primary personal KV Code repo skill.".to_string(),
