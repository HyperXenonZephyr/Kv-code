...
impl BottomPane {
    ...
    pub(crate) fn set_context_window(
        ...
        if self.context_window_percent == percent
            ...
            && self.context_window_size_tokens == window_tokens
        {
            return;
        }
        ...
        self.context_window_size_tokens = window_tokens;
        self.composer
            .set_context_window(percent, self.context_window_used_tokens, window_tokens);
        self.request_redraw();
    }
...
mod tests {
    ...
    fn test_pane_with_disable_paste_burst(
        ...
        BottomPane::new(BottomPaneParams {
            ...
            placeholder_text: "Ask KV Code to do anything".to_string(),
            disable_paste_burst,
