...
//!
//! This module owns the auth-step state machine (API
...
impl AuthModeWidget {
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  KV Code will use usage-based billing with your API key.".into(),
        ];
    ...
    pub(crate) fn on_account_login_completed(
        ...
        // Browser/account login variants have been removed; API key login does not
        // use account login completion notifications.
    }
