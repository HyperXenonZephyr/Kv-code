...
//! "leave the old title alone" or "clear the title KV Code last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title KV Code manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before KV Code started managing the title.
