...
# Add this to ~/.kv-code/config.toml:

[model_providers.kv-code-responses-api-proxy]
...
- We leverage [`codex_process_hardening`](https://github.com/openai/codex/blob/main/kv-code-rs/process-hardening/README.md) so `codex-responses-api-proxy` is run with standard process-hardening techniques.
